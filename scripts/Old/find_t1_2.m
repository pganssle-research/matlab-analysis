function [t1, t1_std, t1s] = find_t1_2(curves, indir_times, num_measurements, start_index, end_index)
    ...
    for i = 1:num_measurements
		...
		[x resnorm resid exitflag] = lsqcurvefit(@exponential_square_fit, [0.8, 0.15], indir_times, v, [], [], o);   
		fit(i, 1:2) = x(1:2);
        fit(i, 3) = exitflag;
	end
