function [spectrum, f1, f2, fid, t1, t2] = sim_2D_2pulse(j_couplings, spins, enriched, pulse_length_1, pulse_length_2, bias_field, r)
...
min_ab = 0;     % Terms with abundance less than this are ignored.
c_ab = 0;
...
%relaxation = exp(-(t1^2)'/r)*exp(-(t2^2)/r);
