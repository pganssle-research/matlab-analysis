function [spectrum, f, fid, t] = sim_j_win(j_couplings, spins, enriched, p_l_1, space)
...
%
% Usage:
% [spectrum, f, fid, t] = simulate_J(j_couplings, spins, enriched, p_l_1, space);
...
nw = 16
np = ; % Number of points in the direct dimension
sr = 700; % Sampling rate in the direct dimension in Hz
...
pulse = expm(-1i*h_pulse*p_l_1); % Time = 4 pi on hydrogen
