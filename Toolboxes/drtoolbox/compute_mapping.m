...
%     if ~isnumeric(no_dims) || no_dims < 1 || no_dims > size(A, 2) || round(no_dims) ~= no_dims
...
%     
    ...
    switch type
        ...
        case {'AutoEncoder', 'Autoencoder', 'AutoencoderRBM', 'AutoEncoderRBM'}
            ...
            [mappedA, network] = train_autoencoder(A, net_structure);
        ...
        case 'LMNN'
            error('LMNN is not yet implemented in the toolbox.');
